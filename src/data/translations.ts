...
export const translations: Record<Language, TranslationContent> = {
  ...
  ar: {
    ...
    proof: {
      ...
      items: [
        {
          ...
          desc: "تطبيقات متكاملة تم بناؤها باستخدام أحدث أطر العمل، مع خلفيات برمجية قابلة للتوسع وأمان كامل.",
          tech: ["React", "TypeScript", "Vite", "Node.js"],
      ...
      highlights: ["+30 تطبيقاً تم إطلاقها", "تحقق Zero-Trust", "+500 اختبار ناجح"]
    },
    caseStudy: {
    ...
    engineering: {
      ...
      skillsCountLabel: "{count} كفاءة هندسية أساسية",
      categories: [
        {
    ...
    education: {
      ...
      academicDegree: "طالب بكلية الهندسة – قسم الكمبيوتر / البرمجة",
    ...
    security: {
      ...
      headline: "أنا لا أثق في العميل (THE CLIENT).",
      ...
      principleDesc: "كل طلب HTTP قادم يُعامل كطلب غير موثوق. الواجهة الأمامية تلتقط رغبة المستخدم فقط، بينما يتولى الخادم التحقق من الهوية، الصلاحيات، المخططات، وقواعد البيانات.",
      ...
      flowTitle: "مسار معالجة الطلبات الآمن",
    ...
    process: {
      ...
      steps: [
        { num: "01", title: "الفهم والتحليل", desc: "تحليل الأهداف، متطلبات المستخدم، القيود التقنية، ومواصفات النظام.", deliverable: "وثيقة النطاق والـ Requirements" },
        { num: "02", title: "التصميم المعماري", desc: "تصميم نماذج البيانات، هيكلة نقاط الـ API، سياسات الأمان، وحالة الواجهات.", deliverable: "مخطط بنية النظام والمخططات" },
    ...
    contact: {
      ...
      types: ["تطبيق ويب متكامل", "تطبيق أندرويد هاتف", "دمج حلول الذكاء الاصطناعي", "فحص وتأمين الأمان", "منتج رقمي شامل"],
      budgets: ["1 - 2 أسابيع", "3 - 4 أسابيع", "1 - 2 أشهر", "دعم واستشارات مستمرة"],
