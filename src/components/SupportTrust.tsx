      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-12">
          ...
          <SectionEntrance
            ...
            className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-4 sm:gap-5"
          >
        ...
        {/* GitHub & LinkedIn Profile Statements */}
        ...
        <div className="mt-4 sm:mt-5 rounded-2xl bg-[var(--bg-card)] border border-[var(--border-subtle)] p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-5 shadow-lg">
          <div className="flex items-center space-x-4 rtl:space-x-reverse">
            <div className="w-11 h-11 rounded-xl bg-[var(--bg-surface-2)] border border-[var(--border-subtle)] flex items-center justify-center text-[var(--accent-cyan)] shrink-0">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
